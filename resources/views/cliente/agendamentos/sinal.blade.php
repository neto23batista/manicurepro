...
@section('title', 'Pagar sinal')
@section('page-title', 'Pagar sinal')
    ...
    <div class="col-lg-6">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 text-center">
                <h5 class="fw-bold mb-1">Sinal do agendamento</h5>
                ...
                <div class="display-6 fw-bold text-gradient mb-1">
                    R$ {{ number_format($agendamento->sinal_valor, 2, ',', '.') }}
                </div>
                <p class="text-muted small mb-4">Pague via Pix para garantir seu horário.</p>
...
const statusUrl = "{{ route('cliente.agendamentos.sinal.status', $agendamento) }}";
